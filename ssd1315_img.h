...
#define SSD1315_IMG_ARRAY(var_, size_, colsX_, pagesY_) uint8_t var_ ## Buf[size_ * (colsX_ * pagesY_ + 1)]; SSD1315_IMG var_ ## [size_]; ssd1315_img_array_init((SSD1315_IMG *)&var_, var_ ## Buf, size_, colsX_, pagesY_)
